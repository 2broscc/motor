...
$out['copyright'] = "<a href=\"http://www.neocrome.net\">".$L['foo_poweredby']." engine</a>";

/* ======== Skin ======== */
$user_skin_dir = $cfg['default_skin_dir']; //from beallit.php

$usr['skin_raw'] = $usr['skin'];

if (@file_exists ( "$user_skin_dir/".$usr['skin']."".$usr['lang']."/header.tpl " )) { 
...
$usr['skin_lang'] = "$user_skin_dir/".$usr['skin']."/".$usr['skin_raw'].".".$usr['lang'].".lang.php";
...
require("$user_skin_dir/".$usr['skin']."/".$usr['skin'].".php");
