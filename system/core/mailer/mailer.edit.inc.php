...
Filename: mailer.edit.inc.php
CMS Framework based on Seditio v121 
Reprogrammed by 2bros cc
date:02-02-2011
...
elseif ($a=='delete')
	...
	header("Location: mailer.php?f=$f");
	exit;
	}
elseif ($a=='update')
	{
