...
if ($f=='search' && strlen($y)>1)
	...
	$sql = sed_sql_query("SELECT * FROM $db_users WHERE user_name LIKE '%".sed_sql_prep($y)."%' ORDER BY user_name ASC LIMIT $d,".$cfg['maxusersperpage']);
	}
elseif ($g>1)
	{
...
foreach ($sed_countries as $i => $x)
	...
	if ($i=='00')
		{
		$allfilters .= "<option value=\"\">".$L['Country']."...";
		$selected = ("country_00"==$f) ? "selected=\"selected\"" : '';
		$allfilters .= "<option value=\"users.php?f=country_00\" ".$selected.">".$L['None'];
		}
       else
       	{
       	$selected = ("country_".$i==$f) ? "selected=\"selected\"" : '';
       	$allfilters .= "<option value=\"users.php?f=country_".$i."\" ".$selected.">".sed_cutstring($x,23);
       	}
	}
...
$t->assign(array(
	"USERS_TOP_USERID" => "<a href=\"users.php?f=$f&amp;s=id&amp;w=asc&amp;g=$g&amp;gm=$gm\">$sed_img_down</a> <a href=\"users.php?f=$f&amp;s=id&amp;w=desc&amp;g=$g&amp;gm=$gm\">$sed_img_up</a> ".$L['Userid'],
	"USERS_TOP_NAME" => "<a href=\"users.php?f=$f&amp;s=name&amp;w=asc&amp;g=$g&amp;gm=$gm\">$sed_img_down</a> <a href=\"users.php?f=$f&amp;s=name&amp;w=desc&amp;g=$g&amp;gm=$gm\">$sed_img_up</a> ".$L['Username'],
	"USERS_TOP_MAINGRP" => "<a href=\"users.php?f=$f&amp;s=maingrp&amp;w=asc&amp;g=$g&amp;gm=$gm\">$sed_img_down</a> <a href=\"users.php?f=$f&amp;s=maingrp&amp;w=desc&amp;g=$g&amp;gm=$gm\">$sed_img_up</a> ".$L['Maingroup'],
	"USERS_TOP_COUNTRY" => "<a href=\"users.php?f=$f&amp;s=country&amp;w=asc&amp;g=$g&amp;gm=$gm\">$sed_img_down</a> <a href=\"users.php?f=$f&amp;s=country&amp;w=desc&amp;g=$g&amp;gm=$gm\">$sed_img_up</a> ".$L['Country'],
	"USERS_TOP_TIMEZONE" => "<a href=\"users.php?f=$f&amp;s=timezone&amp;w=asc&amp;g=$g&amp;gm=$gm\">$sed_img_down</a> <a href=\"users.php?f=$f&amp;s=timezone&amp;w=desc&amp;g=$g&amp;gm=$gm\">$sed_img_up</a> ".$L['Timezone'],
	"USERS_TOP_EMAIL" => "<a href=\"users.php?f=$f&amp;s=email&amp;w=asc&amp;g=$g&amp;gm=$gm\">$sed_img_down</a> <a href=\"users.php?f=$f&amp;s=email&amp;w=desc&amp;g=$g&amp;gm=$gm\">$sed_img_up</a> ".$L['Email'],
	"USERS_TOP_REGDATE" => "<a href=\"users.php?f=$f&amp;s=regdate&amp;w=asc&amp;g=$g&amp;gm=$gm\">$sed_img_down</a> <a href=\"users.php?f=$f&amp;s=regdate&amp;w=desc&amp;g=$g&amp;gm=$gm\">$sed_img_up</a> ".$L['Registered'],
	"USERS_TOP_LASTLOGGED" => "<a href=\"users.php?f=$f&amp;s=lastlog&amp;w=asc&amp;g=$g&amp;gm=$gm\">$sed_img_down</a> <a href=\"users.php?f=$f&amp;s=lastlog&amp;w=desc&amp;g=$g&amp;gm=$gm\">$sed_img_up</a> ".$L['Lastlogged'],
	"USERS_TOP_LOGCOUNT" => "<a href=\"users.php?f=$f&amp;s=logcount&amp;w=asc&amp;g=$g&amp;gm=$gm\">$sed_img_down</a> <a href=\"users.php?f=$f&amp;s=logcount&amp;w=desc&amp;g=$g&amp;gm=$gm\">$sed_img_up</a> ".$L['Count'],
	"USERS_TOP_LOCATION" => "<a href=\"users.php?f=$f&amp;s=location&amp;w=asc&amp;g=$g&amp;gm=$gm\">$sed_img_down</a> <a href=\"users.php?f=$f&amp;s=location&amp;w=desc&amp;g=$g&amp;gm=$gm\">$sed_img_up</a> ".$L['Location'],
	"USERS_TOP_OCCUPATION" => "<a href=\"users.php?f=$f&amp;s=occupation&amp;w=asc&amp;g=$g&amp;gm=$gm\">$sed_img_down</a> <a href=\"users.php?f=$f&amp;s=occupation&amp;w=desc&amp;g=$g&amp;gm=$gm\">$sed_img_up</a> ".$L['Occupation'],
	"USERS_TOP_BIRTHDATE" => "<a href=\"users.php?f=$f&amp;s=birthdate&amp;w=asc&amp;g=$g&amp;gm=$gm\">$sed_img_down</a> <a href=\"users.php?f=$f&amp;s=birthdate&amp;w=desc&amp;g=$g&amp;gm=$gm\">$sed_img_up</a> ".$L['Birthdate'],
	"USERS_TOP_GENDER" => "<a href=\"users.php?f=$f&amp;s=gender&amp;w=asc&amp;g=$g&amp;gm=$gm\">$sed_img_down</a> <a href=\"users.php?f=$f&amp;s=gender&amp;w=desc&amp;g=$g&amp;gm=$gm\">$sed_img_up</a> ".$L['Gender'],
	"USERS_TOP_TIMEZONE" => "<a href=\"users.php?f=$f&amp;s=timezone&amp;w=asc&amp;g=$g&amp;gm=$gm\">$sed_img_down</a> <a href=\"users.php?f=$f&amp;s=timezone&amp;w=desc&amp;g=$g&amp;gm=$gm\">$sed_img_up</a> ".$L['Timezone']
		));
...
if ($d>0)
	...
	$t->assign("USERS_TOP_PAGEPREV",
		"<a href=\"users.php?f=$f&amp;g=$g&amp;gm=$gm&amp;s=$s&amp;w=$w&amp;d=$prevpage\">".$L['Previous']." $sed_img_left</a>");
	}
...
if (($d + $cfg['maxusersperpage'])<$totalusers)
	...
	$t->assign("USERS_TOP_PAGENEXT",
		"<a href=\"users.php?f=$f&amp;g=$g&amp;gm=$gm&amp;s=$s&amp;w=$w&amp;d=$nextpage\">$sed_img_right ".$L['Next']."</a>");
	}
...
while ($urr = sed_sql_fetcharray($sql) AND $jj < $cfg['maxusersperpage'])
	...
	$t-> assign(array(
		...
		"USERS_ROW_GROUPS" => sed_build_groupsms($urr['user_id']),
