...
$profile_form_avatar .= (!empty($urr['user_avatar'])) ? "<img src=\"".$urr['user_avatar']."\" alt=\"\" /> ".$L['Delete']." [<a href=\"users.php?m=profile&amp;a=avatardelete&amp;".sed_xg()."\">x</a>]" : '';
...
//$mskin = "$user_skin_dir/".$skin."/users.profile.tpl"; 
...
if (empty($urr['user_photo'])) {
	...
	$urr['user_photo'] = "skins/ice/img/user_default_avatar.png";

}

$t->assign(array(
	
	"PHOTO" => "<div id=\"profile_img_border\"><img src=\"".$urr['user_photo']."\"/></div>",
