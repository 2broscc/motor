...
if ($a=='add') 	{
	...
	$newpageextra6 = sed_import('newpageextra6','P','TXT');
	$newpageextra7 = sed_import('newpageextra7','P','TXT');
...
/*Adding default preview img if the user did not set up a personal one.*/
	 ...
	 if (empty($newpageextra6)) { $newpageextra6 = "datas/default/nopic.png"; }

//require("system/header.php");

$mskin = "$user_skin_dir/".$skin."/mobile/page.add.tpl"; 
...
$t->assign(array(
	...
	"PAGEADD_FORM_KEY" => "<input type=\"text\" class=\"skinned\" name=\"newpagekey\" value=\"".sed_cc($newpagekey)."\" size=\"16\" maxlength=\"16\" />",
	"PAGEADD_FORM_ALIAS" => "<input type=\"text\" class=\"skinned\" name=\"newpagealias\" value=\"".sed_cc($newpagealias)."\" size=\"16\" maxlength=\"24\" />",
	"PAGEADD_FORM_EXTRA1" => "<input type=\"text\" class=\"skinned\" name=\"newpageextra1\" value=\"".sed_cc($newpageextra1)."\" size=\"56\" maxlength=\"255\" />",
	"PAGEADD_FORM_EXTRA2" => "<input type=\"text\" class=\"skinned\" name=\"newpageextra2\" value=\"".sed_cc($newpageextra2)."\" size=\"56\" maxlength=\"255\" />",
	"PAGEADD_FORM_EXTRA3" => "<input type=\"text\" class=\"skinned\" name=\"newpageextra3\" value=\"".sed_cc($newpageextra3)."\" size=\"56\" maxlength=\"255\" />",
	"PAGEADD_FORM_EXTRA4" => "<input type=\"text\" class=\"skinned\" name=\"newpageextra4\" value=\"".sed_cc($newpageextra4)."\" size=\"56\" maxlength=\"255\" />",
	"PAGEADD_FORM_EXTRA5" => "<input type=\"text\" class=\"skinned\" name=\"newpageextra4\" value=\"".sed_cc($newpageextra4)."\" size=\"56\" maxlength=\"255\" />",
	
	//for imgs
	"PAGEADD_FORM_EXTRA6" => "<input type=\"text\" class=\"skinned\" name=\"newpageextra6\" value=\"".$cfg['pfs_dir']."/".sed_cc($newpageextra6)."\" size=\"56\" maxlength=\"255\" />",
	
	"PAGEADD_FORM_EXTRA7" => "<input type=\"text\" class=\"skinned\" name=\"newpageextra7\" value=\"".sed_cc($newpageextra7)."\" size=\"56\" maxlength=\"255\" />",
	
	"PAGEADD_FORM_TITLE" => "<input type=\"text\" class=\"skinned\" name=\"newpagetitle\" value=\"".sed_cc($newpagetitle)."\" size=\"56\" maxlength=\"255\" />",
	"PAGEADD_FORM_DESC" => "<input type=\"text\" class=\"skinned\" name=\"newpagedesc\" value=\"".sed_cc($newpagedesc)."\" size=\"56\" maxlength=\"255\" />",
	"PAGEADD_FORM_AUTHOR" => "<input type=\"text\" class=\"skinned\" name=\"newpageauthor\" value=\"".sed_cc($newpageauthor)."\" size=\"16\" maxlength=\"24\" />",
	...
	"PAGEADD_FORM_URL" => "<input type=\"text\" class=\"skinned\"  name=\"newpageurl\" value=\"".sed_cc($newpageurl)."\" size=\"56\" maxlength=\"255\" /> ".$pfs_form_url_myfiles,
	"PAGEADD_FORM_SIZE" => "<input type=\"text\" class=\"skinned\"  name=\"newpagesize\" value=\"".sed_cc($newpagesize)."\" size=\"56\" maxlength=\"255\" />",
