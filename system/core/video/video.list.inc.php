...
//listing only the "videosarok" category items
...
elseif ($c=='all' && $usr['isadmin'])
	{
	$sql = sed_sql_query("SELECT COUNT(*) FROM $db_videos WHERE page_state='0'");
	$totallines = sed_sql_result($sql, 0, "COUNT(*)");
	$sql = sed_sql_query("SELECT p.*, u.user_name ".$join_ratings_columns."
		FROM $db_videos as p ".$join_ratings_condition."
...
elseif (!empty($o) && !empty($p) && $p!='password')
	{
	$sql = sed_sql_query("SELECT COUNT(*) FROM $db_videos WHERE page_cat='$c' AND (page_state='0' OR page_state='2') AND page_$o='$p'");
	$totallines = sed_sql_result($sql, 0, "COUNT(*)");
	$sql = sed_sql_query("SELECT p.*, u.user_name ".$join_ratings_columns."
		FROM $db_videos as p ".$join_ratings_condition."
		LEFT JOIN $db_users AS u ON u.user_id=p.page_ownerid
...
$submitnewpage = ($usr['auth_write'] && $c!='all') ? "<a href=\"video.php?m=add&amp;c=".$c."\">".$L['lis_submitnew']."</a>" : '';
...
if ($c=='all' || $c=='system')
	...
	{ $catpath = sed_build_catpath($c, "<a href=\"videolist.php\">%2\$s</a>"); }
...
if ($d>0)
	...
	if ($prevpage < 0)
		{ $prevpage=0; }
	//$pageprev = "<a href=\"videolist.php?c=$c&amp;s=$s&amp;w=$w&amp;o=$o&amp;p=$p&amp;d=$prevpage\">".$L['Previous']." $sed_img_left</a>";
	$pageprev = "<a href=\"videolist.php?c=$c&amp;s=$s&amp;w=$w&amp;o=$o&amp;p=$p&amp;d=$prevpage\">$sed_img_left</a>";
	}

if (($d + $cfg['maxrowsperpage']) < $totallines)
	{
	$nextpage = $d + $cfg['maxrowsperpage'];
	//$pagenext = "<a href=\"videolist.php?c=$c&amp;s=$s&amp;w=$w&amp;o=$o&amp;p=$p&amp;d=$nextpage\">$sed_img_right ".$L['Next']."</a>";
	$pagenext = "<a href=\"videolist.php?c=$c&amp;s=$s&amp;w=$w&amp;o=$o&amp;p=$p&amp;d=$nextpage\">$sed_img_right</a>";
	}

list($list_comments, $list_comments_display) = sed_build_comments($item_code, 'video.php?m=$c', $comments);
list($list_ratings, $list_ratings_display) = sed_build_ratings($item_code, 'video.php?m=$c', $ratings);
...
$mskin = "$user_skin_dir/".$skin."/video.list.tpl";
$t = new XTemplate($mskin);

$t->assign(array(
	"LIST_PAGETITLE" => $catpath,
	"LIST_CATEGORY" => "<a href=\"video.php?m=$c\">".$sed_cat[$c]['title']."</a>",
	"LIST_CAT" => $c,
...
if (!$sed_cat[$c]['group'])
	...
	"LIST_TOP_TITLE" => "<a href=\"videolist.php?c=$c&amp;s=title&amp;w=asc&amp;o=$o&amp;p=$p\">$sed_img_down</a>
	<a href=\"videolist.php?c=$c&amp;s=title&amp;w=desc&amp;o=$o&amp;p=$p\">$sed_img_up</a> ".$L['Title'],
	"LIST_TOP_KEY" => "<a href=\"videolist.php?c=$c&amp;s=key&amp;w=asc&amp;o=$o&amp;p=$p\">$sed_img_down</a>
	<a href=\"videolist.php?c=$c&amp;s=key&amp;w=desc&amp;o=$o&amp;p=$p\">$sed_img_up</a> ".$L['Key'],
	"LIST_TOP_EXTRA1" => "<a href=\"videolist.php?c=$c&amp;s=extra1&amp;w=asc&amp;o=$o&amp;p=$p\">$sed_img_down</a>
	<a href=\"videolist.php?c=$c&amp;s=extra1&amp;w=desc&amp;o=$o&amp;p=$p\">$sed_img_up</a>",
	"LIST_TOP_EXTRA2" => "<a href=\"videolist.php?c=$c&amp;s=extra2&amp;w=asc&amp;o=$o&amp;p=$p\">$sed_img_down</a>
	<a href=\"videolist.php?c=$c&amp;s=extra2&amp;w=desc&amp;o=$o&amp;p=$p\">$sed_img_up</a>",
	"LIST_TOP_EXTRA3" => "<a href=\"videolist.php?c=$c&amp;s=extra3&amp;w=asc&amp;o=$o&amp;p=$p\">$sed_img_down</a>
	<a href=\"videolist.php?c=$c&amp;s=extra3&amp;w=desc&amp;o=$o&amp;p=$p\">$sed_img_up</a>",
	"LIST_TOP_EXTRA4" => "<a href=\"videolist.php?c=$c&amp;s=extra4&amp;w=asc&amp;o=$o&amp;p=$p\">$sed_img_down</a>
	<a href=\"videolist.php?c=$c&amp;s=extra4&amp;w=desc&amp;o=$o&amp;p=$p\">$sed_img_up</a>",
	"LIST_TOP_EXTRA5" => "<a href=\"videolist.php?c=$c&amp;s=extra5&amp;w=asc&amp;o=$o&amp;p=$p\">$sed_img_down</a>
	<a href=\"videolist.php?c=$c&amp;s=extra5&amp;w=desc&amp;o=$o&amp;p=$p\">$sed_img_up</a>",
	"LIST_TOP_DATE" => "<a href=\"videolist.php?c=$c&amp;s=date&amp;w=asc&amp;o=$o&amp;p=$p\">$sed_img_down</a>
	<a href=\"videolist.php?c=$c&amp;s=date&amp;w=desc&amp;o=$o&amp;p=$p\">$sed_img_up</a> ".$L['Date'],
	"LIST_TOP_AUTHOR" => "<a href=\"videolist.php?c=$c&amp;s=author&amp;w=asc&amp;o=$o&amp;p=$p\">$sed_img_down</a>
	<a href=\"videolist.php?c=$c&amp;s=author&amp;w=desc&amp;o=$o&amp;p=$p\">$sed_img_up</a> ".$L['Author'],
	"LIST_TOP_OWNER" => "<a href=\"videolist.php?c=$c&amp;s=ownerid&amp;w=asc&amp;o=$o&amp;p=$p\">$sed_img_down</a>
	<a href=\"videolist.php?c=$c&amp;s=ownerid&amp;w=desc&amp;o=$o&amp;p=$p\">$sed_img_up</a> ".$L['Owner'],
	"LIST_TOP_COUNT" => "<a href=\"videolist.php?c=$c&amp;s=count&amp;w=asc&amp;o=$o&amp;p=$p\">$sed_img_down</a>
	<a href=\"videolist.php?c=$c&amp;s=count&amp;w=desc&amp;o=$o&amp;p=$p\">$sed_img_up</a> ".$L['Hits'],
	"LIST_TOP_FILECOUNT" => "<a href=\"videolist.php?c=$c&amp;s=filecount&amp;w=asc&amp;o=$o&amp;p=$p\">$sed_img_down</a>
	<a href=\"videolist.php?c=$c&amp;s=filecount&amp;w=desc&amp;o=$o&amp;p=$p\">$sed_img_up</a> ".$L['Hits']
		));
	}
...
while ($pag = sed_sql_fetcharray($sql) and ($jj<=$cfg['maxrowsperpage']))
	...
	$pag['admin'] = $usr['isadmin'] ? "<a href=\"admin.php?m=page&amp;s=queue&amp;a=unvalidate&amp;id=".$pag['page_id']."&amp;".sed_xg()."\">".$L['Putinvalidationqueue']."</a> &nbsp;<a href=\"video.php?m=edit&amp;id=".$pag['page_id']."&r=list\">".$L['Edit']."</a> " : '';
	$kep = 	$pag['page_desc'];
	$t-> assign(array(
		...
		"LIST_ROW_DESC" => "<img src=\"$kep\" width=\"114\" heigth=\"84\"  alt=\"Nincs kép megadva!\" />",
		...
		/*--------------------User defined tags ---- LIST_UDEF_  */
		
		"LIST_UDEF_VIDEO" => "<iframe src=\"http://player.vimeo.com/video/$vimeoid?title=0&amp;byline=0&amp;portrait=0&amp;color=ffffff\" width=\"900px\" height=\"400px\" frameborder=\"0\"></iframe>",
