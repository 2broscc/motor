...
$t = new XTemplate("$user_skin_dir/".$skin."/polls.tpl");
...
elseif ($id=='viewall')
	...
	echo	$percentbar = floor($percent * 2.24);
		...
		$result .= "</td>
			...
			<div style=\"width:256px;\">
						...
						<img  src=\"skins/rlmtb/img/poll/poll_graph_b_left.png\"  />
						<div class=\"bar_front\" style=\"width:".$percent."%;\"></div><div id=\"bar_front_right\"></div>
				
			</div>
			</td>
				<td>$percent%</td><td>(".$po_count.")</td></tr>";
