...
switch ($n)
	...
	while ($row = sed_sql_fetchassoc($sql))
		...
		$adminmain .= ($o=='core') ? "<a href=\"admin.php?m=config&amp;n=edit&amp;o=".$o."&amp;p=".$p."&amp;a=reset&amp;v=".$config_name."\"><img src=\"system/img/admin/reset.png\" alt=\"\" /></a>" : '';
		$adminmain .= ($o=='plug') ? "<a href=\"admin.php?m=config&amp;n=edit&amp;o=".$o."&amp;p=".$p."&amp;a=reset&amp;v=".$config_name."\"><img src=\"system/img/admin/reset.png\" alt=\"\" /></a>" : '&nbsp;';    
		$adminmain .= "</td>";
		$adminmain .= "</tr>";
		}
