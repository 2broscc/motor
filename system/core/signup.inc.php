...
*/			
		...
		this was the problem when users tried to activat their profiles
		
		*/
		
		$ractivate = $cfg['mainurl']."/signup.php?m=register&a=validate&v=".$validationkey;
...
$t = new XTemplate("$user_skin_dir/".$skin."/singup.tpl");
...
$t->assign(array(
	...
	"USERS_REGISTER_SEND" => "signup.php?a=add",
	...
	"USERS_REGISTER_PASSWORD" => "<input type=\"password\" class=\"password\" name=\"rpassword1\" size=\"8\" maxlength=\"16\" onKeyUp=\"analyzePassword(this, 'strength');\" />",
	...
	"USERS_REGISTER_CHECKED" => "<input type=\"checkbox\" name=\"checkbox\" value=\"1\">",
