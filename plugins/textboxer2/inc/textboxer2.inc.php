...
function tb2_getSettings(){
	...
	$res['object'] = array('[object]', '[/object]', 55);
...
//	$res['linkp'] = array('[link=ID]', '[/link]', 37);
	...
	//for videos
	$res['vimeo'] = array('[vimeo=]', '', 60);
	$res['pinkbike'] = array('[pinkbike=]', '', 61);
	$res['freecaster'] = array('[freecaster=]', '', 62);
	$res['mpora'] = array('[mpora=]', '', 63);
	$res['ridelinemtb'] = array('[ridelinemtb=]', '', 64);
	
	$res['vimeobig(640480)'] = array('[vimeobig=]', '', 65);
	$res['pinkbikebig(640480)'] = array('[pinkbike_big=]', '', 66);
	
	$res['kep'] = array('[img_f]', '[/img_f]', 67);
	
	$res['kep_title'] = array('[image=]', '[/image]', 68);
	...
	$res['hide'] = array('[hide]', '[/hide]', 11);
	$res['justify'] = array('[justify]', '[/justify]', 8);
	$res['h1'] = array('[h1]', '[/h1]', 4);
	$res['h2'] = array('[h2]', '[/h2]', 4);
	$res['h3'] = array('[h3]', '[/h3]', 4);
	$res['h4'] = array('[h4]', '[/h4]', 4);
	$res['h5'] = array('[h5]', '[/h5]', 4);
	$res['strike'] = array('[s]', '[/s]', 23);
	$res['size'] = array('[size=]', '[/size]', 23);
	$res['sizep'] = array('[size=]', '[/size]', 23);
	$res['ol'] = array('[ol]', '[/ol]', 12);
	$res['li'] = array('[li]', '[/li]', 12);
	$res['flash'] = array('[flash]', '[/flash]', 15);
	$res['divx'] = array('[divx]', '[/divx]', 15);
	return $res;
}
